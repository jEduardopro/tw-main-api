...
class ProfileControllerTest extends TestCase
{
    ...
    /** @test */
    public function a_logged_user_can_edit_your_profile_banner()
    {
        $user = User::factory()->activated()->create();
        Passport::actingAs($user);
    ...
    /** @test */
    public function a_logged_user_can_edit_your_profile_image()
    {
        $user = User::factory()->activated()->create();
        Passport::actingAs($user);
    ...
    /** @test */
    public function a_logged_user_can_edit_your_profile_info()
    {
        $user = User::factory()->activated()->create();
        Passport::actingAs($user);
